...
function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // 🔁 Handle redirects via router in an effect
  useEffect(() => {
    if (isLoading) return
  ...
  }, [isLoading, redirectToStatus, userData, router])
  ...
  // While redirect is in progress, render nothing
  if (redirectToStatus || !userData || !userData.role) {
    return null
  }
